...
import { faArrowLeft, faCamera, faCheckCircle, faShare } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome'
import { router } from 'expo-router'
import React, { useState } from 'react'
import { Dimensions, Image, Keyboard, Pressable, SafeAreaView, StatusBar, Text, TextInput, TouchableHighlight, TouchableOpacity, View } from 'react-native'
...
export default function Success() {
    return (
        ...
        >
            ...
            >
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginVertical: 12, color: 'white' }}>
                    Checkin successful
                </Text>
            ...
            >
                ...
                >
                    ...
                    >
                        <FontAwesomeIcon icon={faShare} color='#FFFFFF70' size={24}/>
                    </TouchableHighlight>
                    <TouchableHighlight
                        style={{
                            backgroundColor: '#2E2E2E',
