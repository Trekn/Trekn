...
export default function Navbar() {
    const navBarList = [
        {
            name: 'home',
            path: '/',
            element: (active: boolean) => <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        },
        {
            name: 'search',
            path: '/search',
            element: (active: boolean) => <Svg width="25" height="24" viewBox="0 0 25 24" fill="none">
    ...
    const isShow = () => {
        const allow = ['/', '/account/0', '/search', '/award'];
            ...
            {isShow() &&
                <View style={
                    ...
                    {navBarList.map((item: any,
                        idx: number) => (
                        <TouchableOpacity key={idx} onPress={() => navigate(item.path)} style={{ position: 'relative' }}>
